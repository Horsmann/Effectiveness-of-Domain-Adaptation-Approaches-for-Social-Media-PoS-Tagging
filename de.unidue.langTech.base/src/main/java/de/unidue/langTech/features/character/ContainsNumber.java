...
{
    private static final String FEATURE_NAME = "containsNumber";
        ...
        throws TextClassificationException
    {
        ...
        Feature feature = FeatureUtil.wrapAsFeature(FEATURE_NAME, containsNumber(token));
    ...
    {
        return FeatureUtil.containsNumber(aToken);
    }
}
