package de.unidue.langTech.reTrainExperiment;
 ...
 */
public class ReTrainExperiment
    implements Constants
{
    public static String corpus = null;
    public static String experimentName = "retrain";
        ...
        throws Exception
    {
        ...
        if (args.length != argNum) {
            System.err
                    .println("Require "
                            ...
                            + " argument:\n"
                            + "\t(1)  corpus (file path)\n"
                            + "\t(2)  output folder (folder path were all results/working files will be created)");
            return;
        }
        ...
        ReTrainExperiment experiment = new ReTrainExperiment();
