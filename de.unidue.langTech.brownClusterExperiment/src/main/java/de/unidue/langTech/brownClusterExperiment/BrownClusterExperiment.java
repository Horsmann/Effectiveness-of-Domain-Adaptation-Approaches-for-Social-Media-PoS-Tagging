package de.unidue.langTech.brownClusterExperiment;
 ...
 */
public class BrownClusterExperiment
    implements Constants
{
    public static String corpus = null;
    public static String experimentName = "brownClusterExperiment";
    ...
    private static String brownCluster = null;
        ...
        throws Exception
    {
        ...
        BrownClusterExperiment experiment = new BrownClusterExperiment();
        experiment.validation(pSpace);

        LogFactory.getLog(BrownClusterExperiment.class.getName()).info(
        ...
        throws Exception
    {
        ...
        Dimension<List<String>> dimFeatureSets = Dimension.create(
                ...
                Arrays.asList(new String[] { CurrentToken.class.getName(),
                        ...
                        BrownClusterFeature.class.getName() }));
