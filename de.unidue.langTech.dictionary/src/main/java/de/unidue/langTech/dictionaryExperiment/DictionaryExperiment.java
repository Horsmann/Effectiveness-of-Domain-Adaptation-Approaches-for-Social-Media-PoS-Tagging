package de.unidue.langTech.dictionaryExperiment;
    ...
    implements Constants
{
    ...
    public static String experimentName = "dictionaryExperiment";
        ...
        throws Exception
    {
        ...
        if (args.length != argNum) {
            System.err
                    .println("Require "
                            ...
                            + " arguments:\n"
                            + "\t(1)  corpus (file path)\n"
                            + "\t(2)  dictionary location (file path to json file)\n"
        ...
        DictionaryExperiment experiment = new DictionaryExperiment();
        ...
        throws Exception
    {
        ...
        Dimension<List<Object>> dimPipelineParameters = Dimension.create(
                DIM_PIPELINE_PARAMS,
                Arrays.asList(new Object[] { DictionaryTagFeature.PARAM_DICTIONARY_LOCATION,
                        dictionaryPath, LuceneCharacterNGramPerUnitUFE.PARAM_CHAR_NGRAM_MIN_N, 2,
